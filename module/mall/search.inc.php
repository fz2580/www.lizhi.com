...
if($DT_PC) {
	...
	$sorder  = array($L['order'], $L['order_auto'], $L['price_dsc'], $L['price_asc'], $L['orders_dsc'], $L['orders_asc'], $L['comments_asc'], $L['comments_dsc'], $L['hits_dsc'], $L['hits_asc']);
	$dorder  = array($MOD['order'], '', 'price DESC', 'price ASC', 'orders DESC', 'orders ASC', 'comments DESC', 'comments ASC', 'hits DESC', 'hits ASC');
